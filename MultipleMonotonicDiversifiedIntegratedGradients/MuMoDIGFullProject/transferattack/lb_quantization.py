...
#core implementation of Lower-Bound Quantization (LBQ) module for MuMoDIG attack.
#ensures monotinicity of paths to generate transferable adversarial examples 
...
class LBQuantization(nn.Module):
    ...
    def forward(self, x):
        ...
        x: (B, c, H, W) or (C, H, W)
        """
        #applies LBQ to generate baseline
        #each pixel quanitized to minimum value of region it falls into
        EPSILON = 1
        ...
        #build sorted region ends for checking and quantization         
        ...
        #replace each pixel with it's minimum value region
